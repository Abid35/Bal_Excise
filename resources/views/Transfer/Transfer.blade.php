...
<div id="maindiv" class="container main over">
    ...
    <div class="row">
        ...
        <div class="col-md-3" style="margin-top: 1%">
            ...
            <a href="{{url('/transfer/create')}}" type="button" class="btn  btn-dark">Add New</a>
    ...
    <table class="table table-responsive over" id="dtable" >
        ...
        <thead class="thead-dark" style="border: 1px black; color:black; " >
          ...
          <tr class="headings">
            ...
            <th scope="col">Registraion Mark</th>
        ...
        @foreach($data as $x)
          <tr>
            ...
            @php($j= App\Models\eto_location::find($x->eto_location_id) )
            <td>{{$j->eto_location}}</td>

            <td>{{$x->transfer_code}}</td>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <a href="{{url('/')}}/transfer/{{$x->id}}/edit" class="btn btn-sm btn-clean btn-icon" title="Edit details"><i class="fas fa-edit"></i></a>
                ...
                <div class="col-sm-6">
                    ...
                    <form id="del-form{{$x->id}}" action="{{url('/')}}/transfer/{{$x->id}}" method="POST">
                    @csrf
