            ...
            <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-5"><label>Issuing Authority</label></div>

                            <div class="col-md-7"><select class="form-control" id="AuthorityID" name="AuthorityID"><option></option></select></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-5"><label>Route Permit No</label></div>

                            <div class="col-md-7"><input type="text" class="form-control" id="RoutePermitNo" name="RoutePermitNo" /></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-5"><label>Issue Date</label></div>

                            <div class="col-md-7"><input type="date" class="form-control" id="IssueDate" name="IssueDate" /></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-7"><input type="date" class="form-control" id="ExpiryDate" name="ExpiryDate" /></div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6 text-center">
                        ...
                        <a href="/DEO/Permit"> </a>  <input type="button" class="btn btnCancel" value="CANCEL" />



                        <a onclick="SaveNewPermitInfo();" id="Operation" class="btn btnCustom">APPLY</a>
    ...
    $(document).ready(function () {
       ...
       // LoadReasons();
        ...
        if (value != "") {
            ...
            $("#Operation").attr("onclick", "SaveNewPermitInfo()").unbind("click");

            $("#Operation").attr("onclick", "UpdateNewPermitInfo()").bind("click");
                ...
                if (response.Status == true) {
                    ...
                    if (typeof response != 'undefined' && response != null && response != 0) {
                        ...
                        $.each(response.Data, function (index, value) {
                            ...
                            $('<option value="' + value.id + '">' + value.authority + '</option>').appendTo('#AuthorityID');
...
<script>
    ...
    function SaveNewPermitInfo() {
        ...
        // var Permitvalitade = $('#Permitfrom').valid();
        ...
        // if (Permitvalitade) {
            ...
            var RoutePermitNo = $('#RoutePermitNo').val();
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.Status) {
                    ...
                    $('#RoutePermitNo').val(response.Data[0].RoutePermitNo);

                    $('#ExpiryDate').val(moment(response.Data[0].ExpiryDate).format('YYYY-MM-DD'));

                    $('#IssueDate').val(moment(response.Data[0].IssueDate).format('YYYY-MM-DD'));
                ...
                if (response.Status) {
                    ...
                    swal({
                        ...
                        function (isConfirm) {
                            ...
                            window.location.href = "/DEO/Permit";
