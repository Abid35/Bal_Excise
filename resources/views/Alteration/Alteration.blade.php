...
<div id="maindiv" class="container main over">
    ...
    <div class="row">
        ...
        <div class="col-md-3" style="margin-top: 1%">
            ...
            <a href="{{url('/alteration/create')}}" type="button" class="btn  btn-dark">Add New</a>
    ...
    <table class="table table-responsive over"  id="dtable">
        ...
        @foreach($data as $x)
          <tr>
            ...
            <td>{{ $x->eto_location==null ? 'N/A' : $x->eto_location->eto_location }}</td>



           <td>
                @if($x->new_alteration!=null)
                    @if($x->alteration_code==1)
                        Seating Capacity
                    @elseif($x->alteration_code==2)
                        Engine Capacity
                    @elseif($x->alteration_code==3)
                        Wheel Base
                    @elseif($x->alteration_code==4)
           ...
           <td>
                {{$x->new_alteration==null ? 'N/A' : $x->new_alteration}}
           </td>
