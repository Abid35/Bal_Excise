                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel panel-default mb-50 addnewpanl">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" action="{{ route('jurisdiction.create') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="jurisdiction_name"
                                           class="col-md-4 col-form-label text-md-end">{{ __('Jurisdiction Name') }}</label>

                                    <div class="col-md-6">
                                        <input id="jurisdiction_name" type="text" class="form-control" name="jurisdiction_name" required>
