                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel panel-default mb-50 addnewpanl">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" action="{{ route('typeofbody.create') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="type_of_body"
                                           class="col-md-4 col-form-label text-md-end">{{ __('Type Of Body') }}</label>

                                    <div class="col-md-6">
                                        <input id="type_of_body" type="text" class="form-control" name="type_of_body" required>
