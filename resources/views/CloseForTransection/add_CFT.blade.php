...
<div class="panel panel-default mb-50 addnewpanl">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row form-group">
                        ...
                        <label class="form-check-label" for="flexSwitchCheckChecked"> Vehicle Status (Close or Open For Transcation)</label>
                ...
                <div class="col-md-7">
                    ...
                    <div class="row form-group">
                        ...
                        <input class="form-check-input" type="checkbox" id="TrancationCheck" name="TrancationCheck">
                        <span id="chang"></span>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-7"><select class="form-control" id="BookType" name="BookType"><option>Duplicate</option><option>Card</option></select></div>
    ...
    <div class="col-md-6">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-7"><select class="form-control" id="ReasonID" name="ReasonID"><option></option></select></div>
    ...
    <div class="col-md-6">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-7"><input type="text" class="form-control" id="PoliceStation" name="PoliceStation" /></div>-->
            ...
            <input type="text" class="form-control" id="Inspector" name="Inspector" />-->
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6 text-center">
                        ...
                        <a href="/DEO/CloseTranscation"  <button type="button" class="btn btnCancel">CANCEL</button></a>



                        <a onclick="Saveinfo();" id="Operation" class="btn btnCustom">SUBMIT</a>
...
if (check == false) {
    ...
    $.ajax({
        ...
        data: { RegNo: Regno, DistrictID: District ,ETO_CODE:eto, type : "close"},
            ...
            if (response.Status == true) {
                ...
                $('#OwnerTypeID').val(response.Data.owner_type_id);
                        ...
                        if(response.Data2==null)
                            ...
                            if(response.Data.vehicle_status==1)
                            {
                                $('#TrancationCheck').val('c');
                                $("#chang").html('Close For Transaction');
                            }
                            else if(response.Data.vehicle_status==0)
                            {
                                $('#TrancationCheck').val('o');
                                $("#chang").html('Open For Transaction');
                            }
    ...
    $("#Bookform").validate({
        ...
        rules: {
            ...
            "TrancationCheck"   :{ required:true, minlength : 1 },
    ...
    function Saveinfo() {
        ...
        // if (Bookvalitade) {
            ...
            var TrancationCheck = false;



            if ($('#TrancationCheck').prop("checked")) {

                TrancationCheck = $('#TrancationCheck').val();

            }

            else {

                TrancationCheck = false;
            ...
            $.ajax({
                ...
                url: '{{url("/")}}/AddCloseForTranscation',
                ...
                data: JSON.stringify({
                    ...
                    TrancationCheck: TrancationCheck
                ...
                success: function (response) {
                    ...
                    if (response.Status) {
                        ...
                        if (response.Data == 1) {
                            ...
                            swal("Registration Number   Already Exist");
        ...
        //     swal("please verify your form first!.");
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.Status) {
                        ...
                        if (response.Data[0].TrancationCheck === true) {

                            $('#TrancationCheck').prop("checked", true);

                        }

                        //else {

                        //    $('#TrancationCheck').prop("checked"), false);
                   ...
                   // $('#PoliceStation').val(response.Data[0].PoliceStation);
    ...
    function UpdateBookinfo() {
        ...
        $.ajax({
            ...
            url: '/DEO/UpdateCloseForTranscation',
                ...
                if (response.Status) {
                    ...
                    swal({
                        ...
                        function (isConfirm) {
                            ...
                            window.location.href = "../DEO/CloseTranscation";
