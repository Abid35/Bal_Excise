...
<div class="topTabsSection">
    ...
    <div class="headingDiv wdth100">
        ...
        <h2>Add Stolen Vehicle Detail</h2>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-5"><label>Stolen Number</label></div>

                        <div class="col-md-7"><input type="text" class="form-control" id="StolenCode" name="StolenCode" value="0" readonly /></div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-7"><select class="form-control" id="ReasonID" name="ReasonID"></select></div>
                            ...
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-5"><label>Duplicate Book #</label></div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-5"><label>NUM_PLATE #</label></div>

                                    <div class="col-md-7"><input type="text" class="form-control" id="NUM_PLATE" maxlength="20" name="NUM_PLATE" /></div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <a href="/DEO/Book">  <button type="button" class="btn btnCancel">CANCEL</button></a>
                ...
                if (response.Status == true) {
                    ...
                    if (typeof response != 'undefined' && response != null && response != 0) {
                        ...
                        $.each(response.Data, function (index, value) {
                            ...
                            $('<option value="' + value.id + '">' + value.reason + '</option>').appendTo('#ReasonID');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.Status == true) {
                        ...
                        $("#StolenCode").val(parseInt(response.Data.stolen_code)+parseInt(1));
                    ...
                    if (response.Status) {
                        ...
                        swal({
                            ...
                            function (isConfirm) {
                                ...
                                window.location.href = "{{url('StolenVehicle')}}";
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.Status) {
                    ...
                    $("#StolenCode").val(response.Data[0].StolenCode);
                    ...
                    $('#NUM_PLATE').val(response.Data[0].NUM_PLATE);
