                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel panel-default mb-50 addnewpanl">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" action="{{ route('eto.location.create') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="email"
                                           class="col-md-4 col-form-label text-md-end">{{ __('ETO Name') }}</label>

                                    <div class="col-md-6">
                                        <input id="eto_name" type="text" class="form-control" name="eto_name" required>
