...
$reg = isset($payload['RegNo']) ? trim((string)$payload['RegNo']) : '';
$district = isset($payload['DistrictID']) ? trim((string)$payload['DistrictID']) : '';
...
/* ---------- Upstream config ---------- */
$externalUrl = 'https://115.186.182.227/api/1.0/smart-card/vehicle-info';
